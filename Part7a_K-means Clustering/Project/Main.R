...
## Initialization
rm(list=ls())
sources <- c("computeCentroids.R", "kMeansInitCentroids.R",
...
# dimensional RGB space. In practice, a good strategy for initializing the centroids is 
# to select random examples from the training set. We will first run K-Means on the colors of the pixels in the image and
